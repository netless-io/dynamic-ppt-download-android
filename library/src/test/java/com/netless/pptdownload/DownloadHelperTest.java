...
public class DownloadHelperTest extends TestCase {
    ...
    public void testGetDomainFromSrc() {
        ...
        assertEquals("https://cover.herewhite.com/dfafdad", DownloadHelper.getInstance().getDomainFromSrc(src));
    }
    ...
    public void testGetUUIDFromSrc() {
        ...
        assertEquals("6a212c90fa5311ea8b9c074232aaccd4", DownloadHelper.getInstance().getUUIDFromSrc(src));
    }
}